...
<header class="lok">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="catégorie.html"><h4>Catégories</h4></a>
        </li>
        <!--
        <li class="nav-item">
  ...
  <div class="row">
    <center>
        ...
        <P><i><b>Inscrivez-vous  à notre site afin de profiter de toutes ses fonctionalités!</b></i></P>
...
<form action="" method="post">
			<table style="with: 50%">
			 ...
			 <a class="hok" href="catégorie.html" type="submit">Envoyer</a></br></br></form>
